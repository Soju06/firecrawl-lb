...
The application SHALL expose Firecrawl and health/admin-support routes without mounting active Codex/OpenAI/OAuth/WebSocket proxy routes.

#### Scenario: Old OpenAI and OAuth routes are absent
