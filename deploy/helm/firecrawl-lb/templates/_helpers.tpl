...
{{/*
Headless service name for StatefulSet identity.
*/}}
{{- define "firecrawl-lb.headlessServiceName" -}}
{{- printf "%s-headless" (include "firecrawl-lb.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Stable workload resource name. Separate from fullname to allow controller-kind migration without same-name conflicts.
*/}}
{{- define "firecrawl-lb.workloadName" -}}
{{- printf "%s-workload" (include "firecrawl-lb.fullname" .) | trunc 52 | trimSuffix "-" }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "firecrawl-lb.chart" -}}
...
Common labels
*/}}
{{- define "firecrawl-lb.labels" -}}
helm.sh/chart: {{ include "firecrawl-lb.chart" . }}
{{ include "firecrawl-lb.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "firecrawl-lb.selectorLabels" -}}
app.kubernetes.io/name: {{ include "firecrawl-lb.name" . }}
...
*/}}
{{- define "firecrawl-lb.workloadSelectorLabels" -}}
{{- include "firecrawl-lb.selectorLabels" . }}
firecrawl-lb.soju.dev/traffic: workload
{{- end }}

{{/*
Legacy Deployment traffic selector labels used during controller migration cutover.
*/}}
{{- define "firecrawl-lb.legacySelectorLabels" -}}
{{- include "firecrawl-lb.selectorLabels" . }}
firecrawl-lb.soju.dev/traffic: legacy
{{- end }}

{{/*
ServiceAccount name resolution
*/}}
{{- define "firecrawl-lb.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "firecrawl-lb.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "firecrawl-lb.secretName" -}}
{{- if .Values.auth.existingSecret }}
{{- .Values.auth.existingSecret }}
{{- else }}
{{- include "firecrawl-lb.fullname" . }}
{{- end }}
{{- end }}
...
*/}}
{{- define "firecrawl-lb.databaseUrl" -}}
...
*/}}
{{- define "firecrawl-lb.migrationHookPhases" -}}
...
*/}}
{{- define "firecrawl-lb.migrationServiceAccountName" -}}{{- if and .Values.externalSecrets.enabled .Values.serviceAccount.create -}}{{- include "firecrawl-lb.serviceAccountName" . -}}{{- else if .Values.serviceAccount.name -}}{{- .Values.serviceAccount.name -}}{{- else -}}default{{- end -}}{{- end }}

{{/*
Human-readable install mode label used in NOTES and docs.
*/}}
{{- define "firecrawl-lb.installMode" -}}
{{- if .Values.postgresql.enabled -}}
bundled
...
*/}}
{{- define "firecrawl-lb.nodeSelector" -}}
...
*/}}
{{- define "firecrawl-lb.globalNodeSelector" -}}
