...
or staging firecrawl-lb deployment:

  FIRECRAWL_LB_BASE_URL=https://example.test \
  FIRECRAWL_LB_API_KEY=... \
...
async def _main() -> None:
    ...
    base_url = os.environ["FIRECRAWL_LB_BASE_URL"]
    api_key = os.environ["FIRECRAWL_LB_API_KEY"]
