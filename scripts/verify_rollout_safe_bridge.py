...
def _parse_args() -> VerifyConfig:
    ...
    parser.add_argument("--host", default="firecrawl-lb.localtest.me")
    ...
    parser.add_argument("--rollout-namespace", default="firecrawl-lb-e2e")
    parser.add_argument("--rollout-context", default="kind-firecrawl-lb-local")
    parser.add_argument("--rollout-target", default="statefulset/firecrawl-lb-e2e-workload")
    parser.add_argument("--delete-owner-after-first-turn", action="store_true")
    parser.add_argument("--postgresql-pod", default="firecrawl-lb-e2e-postgresql-0")
    parser.add_argument("--postgresql-user", default="firecrawllb")
    parser.add_argument("--postgresql-database", default="firecrawllb")
    parser.add_argument("--postgresql-secret", default="firecrawl-lb-e2e-postgresql")
